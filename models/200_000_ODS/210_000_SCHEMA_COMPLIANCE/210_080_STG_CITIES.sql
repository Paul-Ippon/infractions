with
    ...
    check_type as(
        select
            ...
            iff(try_cast(latitude as double) is not null, latitude, '{{ var("err_value") }}') as latitude,
            iff(try_cast(longitude as double) is not null, longitude, '{{ var("err_value") }}') as longitude,
